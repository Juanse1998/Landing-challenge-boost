...
const Contact = () => {
  ...
  return (
    <div id="contact" className="bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div
        aria-hidden="true"
      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Realice su reserva o envíenos un mensaje.
        </p>
      </div>
            ...
            <div className="relative mt-2.5">
              <div className="absolute inset-y-0 left-0 flex items-center">
                ...
                <select
                  id="country"
                  name="country"
                  className="h-full rounded-md border-0 bg-transparent py-0 pl-4 pr-9 text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-500 sm:text-sm"
                >
                  <option>US</option>
                  <option>CA</option>
                  <option>EU</option>
